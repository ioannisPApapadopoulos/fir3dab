#!/usr/bin/env python3
"""
Script is originally from the Fluidity project 
https://github.com/FluidityProject/fluidity/blob/main/python/vtktools.py

We use this to transfer coarse solutions to fine meshes for MG 
even if they have been saved with a different number of cores. 
"""
