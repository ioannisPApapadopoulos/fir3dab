...
the higer order discretization for the 2-grid run. Run this script with the same number of cores
...
for porder in range(2,5):
    ...
    for branch in range(2):
        ...
        h5 = HDF5File("../initial-guess-2grid-p-%s/%s.xml.gz"%(porder,branch), "w", comm=comm)
        h5.write(z, "/guess")
        del h5
