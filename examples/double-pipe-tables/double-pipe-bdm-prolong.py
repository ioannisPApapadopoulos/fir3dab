...
class BorrvallProblem(PrimalInteriorPoint):
    ...
    def initial_guesses(self, Z, params):
        ...
        scratch = "/scratch/papadopoulos/3d/double-pipe-analysis/BDM-N-20-nref-%s-output/"%(base_ref-1)
...
if __name__ == "__main__":
    ...
    saving_folder = "/scratch/papadopoulos/3d/double-pipe-analysis/BDM-N-%s-nref-%s-"%(N,base_ref)
    #solutions = deflatedbarrier(problem, params, mu_start=105, mu_end = 104, premature_termination=True, max_halfstep = 0)
